...
import com.qbhsnetschool.widget.ccvideo.global.QaInfo;
import com.qbhsnetschool.widget.ccvideo.manager.ReplayPlayerManager;
 ...
 */
public class ReplayActivity extends CCBaseActivity implements TextureView.SurfaceTextureListener,
    ...
    private DWLiveReplayListener myDWLiveReplayListener = new DWLiveReplayListener() {
        ...
        public void onQuestionAnswer(TreeSet<ReplayQAMsg> qaMsgs) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!QBHSApplication.REPLAY_QA_FOLLOW_TIME) {
        ...
        public void onChatMessage(TreeSet<ReplayChatMsg> replayChatMsgs) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    // 如果不需要根据时间轴展示，就直接交给UI去做展示
                    if (!QBHSApplication.REPLAY_CHAT_FOLLOW_TIME) {
